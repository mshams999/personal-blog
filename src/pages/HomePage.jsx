...
const HomePage = () => {
    ...
    const PostCard = ({ post, index, className = '' }) => {
        ...
        return (
            <Link
                to={`/post/${post.slug}`}
                className={`block bg-white dark:bg-dark-700 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-dark-600 hover:shadow-lg transition-all duration-300 group ${className}`}
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-white dark:bg-dark-700 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-dark-600">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Top Posts</h3>

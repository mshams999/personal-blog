    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50 dark:from-yellow-900/20 dark:via-orange-900/20 dark:to-amber-900/20 py-8" dir="ltr" lang="en">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Certificate Header */}
                <div className="bg-white dark:bg-dark-800 rounded-3xl  overflow-hidden border-2 border-gradient-to-r from-yellow-400 to-orange-500">
                    {/* Header Section */}
                    <div className="bg-gradient-to-r from-yellow-500 via-amber-500 to-orange-500 text-white p-8 relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-6 mb-6 relative z-10">
                            ...
                            <div>
                                <h1 className="text-4xl font-bold drop-">Certificate of Excellence</h1>
                    ...
                    <div className="p-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4 p-4  dark:from-yellow-900/20 dark:to-amber-900/20 rounded-xl border border-yellow-200 dark:border-yellow-700">
                                        <Building className="w-6 h-6 text-amber-600 dark:text-amber-400" />
                                        <div>
                                            <h3 className="font-bold text-ink text-lg">Issuing Organization</h3>
                                            <p className="text-amber-700 dark:text-amber-300 font-medium">Ma'aden Wa'ad Al-Shamaal</p>
                                            <p className="text-ink-muted text-sm">Leading Mining Company in Saudi Arabia</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-4  dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-700">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-ink text-lg">Award Period</h3>
                                            <p className="text-green-700 dark:text-green-300 font-medium">2024 - 2025</p>
                                            <p className="text-ink-muted text-sm">Annual Recognition Period</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-4  dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl border border-purple-200 dark:border-purple-700">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-ink text-lg">Recognition</h3>
                                            <p className="text-purple-700 dark:text-purple-300 font-medium">Certificate of Excellence</p>
                                            <p className="text-ink-muted text-sm">Highest Level Achievement Award</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Key Achievements */}
                                <div>
                                    <h3 className="font-bold text-ink mb-4 text-xl">Key Achievements Recognized</h3>
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            <div className="w-3 h-3  rounded-full"></div>
                                            <span className="text-ink">Outstanding dedication to employee health and safety</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-3 h-3  rounded-full"></div>
                                            <span className="text-ink">Exceptional leadership in medical emergency response</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-3 h-3  rounded-full"></div>
                                            <span className="text-ink">Comprehensive medical services in industrial environment</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-3 h-3  rounded-full"></div>
                                            <span className="text-ink">Innovation in workplace health protocols</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-3 h-3  rounded-full"></div>
                                            <span className="text-ink">Mentorship and team development excellence</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative bg-white dark:bg-dark-700 rounded-2xl p-6 ">
                                        <img
                                            ...
                                            loading="lazy"
                                            className="w-full h-auto rounded-xl  border-4 border-gradient-to-r from-yellow-300 to-orange-400"
                        ...
                        <div className="mt-12 flex flex-wrap gap-4 justify-center">
                            <Link
                                to="/cv"
                                className="inline-flex items-center px-8 py-4  hover:from-amber-700 hover:to-orange-700 text-white font-bold rounded-xl transition-all duration-300  hover: transform hover:-translate-y-1"
                            >

...
const PostCard = ({ post, index = 0 }) => {
    const { getAuthorById, getCategoryById } = useData()
    ...
    return (
        <div className={`card-hover bg-white dark:bg-dark-700 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-dark-600 transition-all duration-300 h-full animate-slide-up ${delayClass}`}>
